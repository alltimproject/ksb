      ...
      <div id="home-content-box">
        <div id="home-content-box-inner">
          ...
          <div id="home-heading" class="animated zoomIn" >
            <h3><i>Kegiatan Baru</i></h3> <br> <h5 class="sub2"> </h5>
          </div>
    ...
    <table class="table table-striped table-valign-middle">
      ...
      <tr>
        ...
        <td>
         ...
         echo $beda->days.' Hari lagi ';
           ?>
        </td>
        <td><?= $key->deskripsi ?></td>
        <td>
          <a href="<?= base_url('informasi/lihatkegiatan/'.$key->id_kegiatan) ?> " class="btn btn-info">LIHAT KEGIATAN</a>
         </td>
      </tr>
    <?php }else{ ?>
        <tr>
          <td colspan="4" class="text-center">Tidak ada kegiatan baru</td>
        </tr>
    <?php } ?>
      <?php endforeach; ?>
      </tbody>
