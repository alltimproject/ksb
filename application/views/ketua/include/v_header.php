...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgb(75, 83, 85); color:black;">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><?= $this->session->userdata('level') ?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <button class="d-block showprofile"><span class="fa fa-user fa-2x "><?php echo $this->session->userdata('level_active') ?></span></button>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
           <a href="<?= base_url('ketua/home') ?>" class="nav-link" id="dashboard">
          ...
          <li class="nav-item">
            <li class="nav-item">
              <a  class="nav-link" href="<?= base_url('ketua/kegiatan') ?>" >
